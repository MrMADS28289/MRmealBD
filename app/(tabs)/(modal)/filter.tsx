  ...
  <>
    <View style={styles.itemContainer}>
      <TouchableOpacity style={styles.item}>
        ...
        <Text className='text-white' style={{ flex: 1 }}>Sort</Text>
        <Ionicons name="chevron-forward" size={22} color={Colors.white} />
      </TouchableOpacity>

      <TouchableOpacity style={styles.item}>
        <Ionicons name="fast-food-outline" size={20} color={Colors.white} />
        <Text className='text-white' style={{ flex: 1 }}>Hygiene rating</Text>
        <Ionicons name="chevron-forward" size={22} color={Colors.white} />
      </TouchableOpacity>

      <TouchableOpacity style={styles.item}>
        <Ionicons name="pricetag-outline" size={20} color={Colors.white} />
        <Text className='text-white' style={{ flex: 1 }}>Offers</Text>
        <Ionicons name="chevron-forward" size={22} color={Colors.white} />
      </TouchableOpacity>

      <TouchableOpacity style={styles.item}>
        <Ionicons name="nutrition-outline" size={20} color={Colors.white} />
        <Text className='text-white' style={{ flex: 1 }}>Dietary</Text>
        <Ionicons name="chevron-forward" size={22} color={Colors.white} />
      </TouchableOpacity>
    </View>
  ...
  const renderItem: ListRenderItem<Category> = ({ item, index }) => (
    <View style={styles.row}>
      ...
      <BouncyCheckbox
        ...
        disableBuiltInState
        iconStyle={{ borderColor: Colors.white, borderRadius: 4, borderWidth: 2 }}
        innerIconStyle={{ borderColor: Colors.white, borderRadius: 4 }}
        onPress={() => {
